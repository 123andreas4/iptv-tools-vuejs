...
export default {
  ...
  methods: {
    ...
    loadSeries() {
      this.isLoading = true;
      this.allProgress([
        httpService.get(`serie/top-rated/${this.movieSeriePlaylist}/0/50`),
        httpService.get(`serie/top-rated/${this.movieSeriePlaylist}/50/50`),
        httpService.get(`serie/top-rated/${this.movieSeriePlaylist}/100/50`),
        httpService.get(`serie/top-rated/${this.movieSeriePlaylist}/150/50`),
        httpService.get(`serie/top-rated/${this.movieSeriePlaylist}/200/50`),
      ], (p) => {
