...
export default {
  ...
  computed: {
    ...
    filteredSeries() {
      if (this.search === null) {
        return this.tmdbSeries;
      } else {
        var re = new RegExp(this.search, "i");
        return this.tmdbSeries.filter((series) => {
          return (
  ...
  methods: {
    ...
    loadSeries() {
      this.isLoading = true;
      this.allProgress([
        httpService.get(`serie/on-the-air/${this.movieSeriePlaylist}/0/50`),
        httpService.get(`serie/on-the-air/${this.movieSeriePlaylist}/50/50`),
        httpService.get(`serie/on-the-air/${this.movieSeriePlaylist}/100/50`),
        httpService.get(`serie/on-the-air/${this.movieSeriePlaylist}/150/50`),
        httpService.get(`serie/on-the-air/${this.movieSeriePlaylist}/200/50`),
      ], (p) => {
