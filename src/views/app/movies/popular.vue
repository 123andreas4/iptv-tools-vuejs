...
export default {
  ...
  methods: {
    ...
    loadMovies() {
      ...
      this.allProgress(
        [
          httpService.get(`movies/popular/${this.movieSeriePlaylist}/0/50`),
          httpService.get(`movies/popular/${this.movieSeriePlaylist}/50/50`),
          httpService.get(`movies/popular/${this.movieSeriePlaylist}/100/50`),
          httpService.get(`movies/popular/${this.movieSeriePlaylist}/150/50`),
          httpService.get(`movies/popular/${this.movieSeriePlaylist}/200/50`),
        ],
        (p) => {
