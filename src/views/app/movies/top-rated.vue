...
export default {
  ...
  methods: {
    ...
    loadMovies() {
      ...
      this.isLoading = true;
      this.allProgress([
        httpService.get(`movies/top-rated/${this.movieSeriePlaylist}/0/50`),
        httpService.get(`movies/top-rated/${this.movieSeriePlaylist}/50/50`),
        httpService.get(`movies/top-rated/${this.movieSeriePlaylist}/100/50`),
        httpService.get(`movies/top-rated/${this.movieSeriePlaylist}/150/50`),
        httpService.get(`movies/top-rated/${this.movieSeriePlaylist}/200/50`),
      ], (p) => {
