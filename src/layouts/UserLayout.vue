<template>
  <div id="root">
    <main class="fixed-background">
      <img src="/assets/logo-white.svg" class="logo" />
      <div class="logo-text">
        <h1 class="title">IPTV-Tools</h1>
        <p class="subtitle">by ERDesigns</p>
      </div>
      <div class="language d-none d-md-block">
        <p class="mb-1">
          <i class="las la-language"></i> {{ $t("user.language") }}
        </p>
        <erd-select :items="languages" v-model="$i18n.locale"></erd-select>
      </div>
      <div class="container">
      ...
      <div class="disclaimer disclaimer-mobile">
        <a href="#" @click.stop.prevent="showConditions = true">{{
          $t("user.terms")
        }}</a>
      </div>
      <transition name="fade">
        <div class="disclaimer-overlay" v-if="showConditions" @click.stop>
          <i
            class="las la-times-circle close"
            @click.stop="showConditions = false"
          ></i>
          <perfect-scrollbar>
            ...
            <h1>General Terms</h1>
            <p>
              By accessing and placing an order with IPTV-Tools, you confirm
              ...
              communication between you and IPTV-Tools.
            </p>
            <p>
              Under no circumstances shall IPTV-Tools team be liable for any
              ...
              even if IPTV-Tools team or an authorized representative has been
            ...
            <p>
              IPTV-Tools will not be responsible for any outcome that may occur
            ...
            <h1>License</h1>
            <p>
              IPTV-Tools grants you a revocable, non-exclusive,
            ...
            <p>
              These Terms & Conditions are a contract between you and IPTV-Tools
              (referred to in these Terms & Conditions as "IPTV-Tools", "us",
              "we" or "our"), the provider of the IPTV-Tools website and the
              services accessible from the IPTV-Tools website (which are
            ...
            <p>
              ...
              IPTV-Tools Service. In these Terms & Conditions, "you" refers both
            ...
            <ul>
              ...
              <li>
                ...
                “our,” it refers to ERDesigns, Leo de bethunelaan 106, 9300
                Aalst, Belgium that is responsible for your information under
                this Terms & Conditions.
              </li>
              <li>
                Country: where IPTV-Tools or the owners/founders of IPTV-Tools
                are based, in this case is BE
              </li>
              <li>
                Device: any internet connected device such as a phone, tablet,
                computer or any other device that can be used to visit
                IPTV-Tools and use the services.
              </li>
              <li>
                Service: refers to the service provided by IPTV-Tools as
              ...
              <li>
                Website: IPTV-Tools's site, which can be accessed via this URL:
                <a href="https://iptv-tools.com">https://iptv-tools.com</a>
              </li>
              <li>
                You: a person or entity that is registered with IPTV-Tools to
                use the Services.
              </li>
            </ul>
            <h1>Restrictions</h1>
            ...
            <ul>
              ...
              <li>
                ...
                notice of copyright or trademark) of IPTV-Tools or its
                affiliates, partners, suppliers or the licensors of the website.
              </li>
            </ul>
            <h1>Return and Refund Policy</h1>
            <p>
              Thanks for shopping at IPTV-Tools. We appreciate the fact that you
            ...
            <p>
              ...
              that apply to transactions at IPTV-Tools. We’ll be as brief as our
              attorneys will allow. The main thing to remember is that by
              placing an order or making a purchase at IPTV-Tools, you agree to
              the terms along with IPTV-Tools's Privacy Policy.
            </p>
            <p>
            ...
            <p>
              ...
              (collectively, "Suggestions") provided by you to IPTV-Tools with
              respect to the website shall remain the sole and exclusive
              property of IPTV-Tools.
            </p>
            <p>
              IPTV-Tools shall be free to use, copy, modify, publish, or
            ...
            <p>
              ...
              IPTV-Tools. We are not responsible for the content, accuracy or
            ...
            <h1>Cookies</h1>
            <p>
              IPTV-Tools uses "Cookies" to identify the areas of our website
            ...
            <p>
              ...
              <span class="iptv-tools">IPTV-Tools</span> may stop (permanently
              or temporarily) providing the Service (or any features within the
              Service) to you or to users generally at
              <span class="iptv-tools">IPTV-Tools</span>’s sole discretion,
              without prior notice to you. You may stop using the Service at any
              time. You do not need to specifically inform
              <span class="iptv-tools">IPTV-Tools</span> when you stop using the
              Service. You acknowledge and agree that if
              <span class="iptv-tools">IPTV-Tools</span> disables access to your
            ...
            <p>
              IPTV-Tools reserves the right to modify, suspend or discontinue,
            ...
            <p>
              IPTV-Tools may from time to time provide enhancements or
            ...
            <p>
              ...
              functionalities of the website. You agree that IPTV-Tools has no
            ...
            <p>
              You acknowledge and agree that IPTV-Tools shall not be responsible
              for any Third-Party Services, including their accuracy,
              completeness, timeliness, validity, copyright compliance,
              legality, decency, quality or any other aspect thereof. IPTV-Tools
            ...
            <p>
              IPTV-Tools may, in its sole discretion, at any time and for any or
            ...
            <p>
              ...
              from IPTV-Tools, in the event that you fail to comply with any
            ...
            <p>
              Termination of this Agreement will not limit any of IPTV-Tools's
            ...
            <p>
              You agree to indemnify and hold IPTV-Tools and its parents,
            ...
            <p>
              ...
              maximum extent permitted under applicable law, IPTV-Tools, on its
              ...
              limitation to the foregoing, IPTV-Tools provides no warranty or
            ...
            <p>
              Without limiting the foregoing, neither IPTV-Tools nor any
              IPTV-Tools's provider makes any representation or warranty of any
              ...
              content, or e-mails sent from or on behalf of IPTV-Tools are free
            ...
            <p>
              ...
              liability of IPTV-Tools and any of its suppliers under any
            ...
            <p>
              ...
              shall IPTV-Tools or its suppliers be liable for any special,
              ...
              even if IPTV-Tools or any supplier has been advised of the
            ...
            <p>
              ...
              legal notices published by IPTV-Tools on the Services, shall
              constitute the entire agreement between you and IPTV-Tools
              ...
              term, and IPTV-Tools's failure to assert any right or provision
              under this Agreement shall not constitute a waiver of such right
              or provision. YOU AND IPTV-Tools AGREE THAT ANY CAUSE OF ACTION
            ...
            <p>
              IPTV-Tools reserves the right, at its sole discretion, to modify
            ...
            <p>
              ...
              IPTV-Tools regarding your use of the website and supersedes all
            ...
            <p>
              ...
              when you use or purchase other IPTV-Tools's services, which
              IPTV-Tools will provide to you at the time of such use or
              purchase.
            </p>
            ...
            <p>
              ...
              arrangement thereof), are owned by IPTV-Tools, its licensors or
              other providers of such material and are protected by BE and
              ...
              permission of IPTV-Tools, unless and except as is expressly
            ...
            <p>
              ...
              REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR IPTV-Tools's
              INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any
              dispute, action, or other controversy between you and IPTV-Tools
            ...
            <p>
              In the event of a dispute, you or IPTV-Tools must give the other a
              ...
              <a href="mailto:ernst@erdesigns.eu">ernst@erdesigns.eu</a>.
              IPTV-Tools will send any Notice of Dispute to you by mail to your
              address if we have it, or otherwise to your email address. You and
              IPTV-Tools will attempt to resolve any dispute through informal
              negotiation within sixty (60) days from the date the Notice of
              Dispute is sent. After sixty (60) days, you or IPTV-Tools may
              commence arbitration.
            </p>
            <h1>Binding Arbitration</h1>
            <p>
              If you and IPTV-Tools don’t resolve any dispute by informal
            ...
            <p>
              ...
              property of IPTV-Tools without any compensation or credit to you
              whatsoever. IPTV-Tools and its affiliates shall have no
            ...
            <h1>Promotions</h1>
            <p>
              IPTV-Tools may, from time to time, include contests, promotions,
            ...
            <p>
              ...
              signed by an authorized representative of IPTV-Tools. IPTV-Tools
              ...
              breach or anticipatory breach by you. IPTV-Tools operates and
              controls the IPTV-Tools Service from its offices in BE. The
              ...
              persons who choose to access the IPTV-Tools Service from other
              ...
              incorporate the IPTV-Tools Privacy Policy) contains the entire
              understanding, and supersedes all prior understandings, between
              you and IPTV-Tools concerning its subject matter, and cannot be
            ...
            <h1>Disclaimer</h1>
            <p>
              IPTV-Tools is not responsible for any content, code or any other
              imprecision.
            </p>
            <p>IPTV-Tools does not provide warranties or guarantees.</p>
            <p>
              In no event shall IPTV-Tools be liable for any special, direct,
            ...
            <p>
              The IPTV-Tools Service and its contents are provided "as is" and
              "as available" without any warranty or representations of any
              kind, whether express or implied. IPTV-Tools is a distributor and
              not a publisher of the content supplied by third parties; as such,
              IPTV-Tools exercises no editorial control over such content and
              makes no warranty or representation as to the accuracy,
              reliability or currency of any information, content, service or
              merchandise provided through or accessible via the IPTV-Tools
              Service. Without limiting the foregoing, IPTV-Tools specifically
              disclaims all warranties and representations in any content
              transmitted on or in connection with the IPTV-Tools Service or on
              sites that may appear as links on the IPTV-Tools Service, or in
              the products provided as a part of, or otherwise in connection
              with, the IPTV-Tools Service, including without limitation any
              warranties of merchantability, fitness for a particular purpose or
              non-infringement of third party rights. No oral advice or written
              information given by IPTV-Tools or any of its affiliates,
              ...
              without notice. Without limiting the foregoing, IPTV-Tools does
              not warrant that the IPTV-Tools Service will be uninterrupted,
            ...
            <ul>
              <li>
                Via Email:
                <a href="mailto:contact@erdesigns.eu">contact@erdesigns.eu</a>
              </li>
              <li>
                Via this Link:
                <a href="https://erdesigns.eu/app/start/contact" target="_blank"
                  >http://erdesigns.eu/contact</a
                >
              </li>
            </ul>
          </perfect-scrollbar>
