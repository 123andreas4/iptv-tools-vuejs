    ...
    <transition-group name="ntf" tag="div" mode="out">
      ...
      >
        <div class="notification-message">
          <i class="las" :class="item.icon" v-if="item.icon"></i>
          <div>
...
export default {
  ...
  methods: {
    /* Solution found on StackOverflow: https://stackoverflow.com/questions/105034/how-to-create-a-guid-uuid/2117523#2117523 */
    createUUID() {
    ...
    addItem(type, title, message, icon, options) {
      let defaultOptions = {
        type: type,
